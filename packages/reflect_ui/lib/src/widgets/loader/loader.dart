...
///
/// {@tool dartpad}
/// This example shows how [ReflectLoader] can be customized.
///
...
class ReflectLoader extends StatefulWidget {
  ...
  /// to 1.0.
  const ReflectLoader.partiallyRevealed({
    super.key,
    this.color,
    this.radius = _kDefaultIndicatorRadius,
    this.progress = 1.0,
  ...
  @override
  State<ReflectLoader> createState() => _ReflectLoaderState();
}

class _ReflectLoaderState extends State<ReflectLoader>
  ...
  @override
  void didUpdateWidget(ReflectLoader oldWidget) {
...
class _ReflectLoaderPainter extends CustomPainter {
  _ReflectLoaderPainter({
  ...
  @override
  bool shouldRepaint(_ReflectLoaderPainter oldPainter) {
...
class Loader extends ReflectLoader {
  const Loader({
    super.key,
    super.color,
    super.animating,
